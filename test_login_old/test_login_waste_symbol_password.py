...
class TestLoginNonexistentUser:
    ...
    def test_login_waste_symbol_password(self):
        """
        Проверка логина: не правильный ввод пароля лишний спец символ/кирилица/казахский в конце или в начале
        """
        driver = self.driver
